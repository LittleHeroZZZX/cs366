...
def run_swiglu(
    ...
    """
    from src.nn import SwiGLU

    layer = SwiGLU(d_model, d_ff)
    layer.linear1.weights.data = w1_weight
    layer.linear2.weights.data = w3_weight
    layer.linear3.weights.data = w2_weight
    return layer(in_features)
...
def run_rope(
    ...
    """
    from src.nn import RotaryPositionalEmbedding
...
def run_transformer_block(
    ...
    layer.ffn.linear2.weights.data = weights["ffn.w3.weight"]
    layer.ffn.linear3.weights.data = weights["ffn.w2.weight"]
    return layer(in_features)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from src.nn.utils import gradient_clipping
...
def run_get_lr_cosine_schedule(
    ...
    """
    from src.nn.utils import get_lr_cosine_schedule
